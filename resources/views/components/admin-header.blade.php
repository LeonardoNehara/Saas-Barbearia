...
<header class="flex min-h-20 items-center justify-between gap-3 border-b border-slate-200/70 bg-white px-4 py-4 sm:px-8 lg:px-9">
    <div class="flex min-w-0 items-center gap-3">
        <button type="button" data-open-menu aria-label="Abrir menu" aria-controls="mobile-menu" aria-expanded="false" @class(['rounded-lg p-2 text-muted hover:bg-slate-100', 'lg:hidden' => ! $alwaysShowMenu])><x-icon name="menu" class="size-5" /></button>
