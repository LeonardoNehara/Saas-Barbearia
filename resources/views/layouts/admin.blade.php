...
<body class="admin-shell bg-slate-50 font-sans text-slate-800 antialiased">
    ...
    <div class="min-h-svh lg:grid lg:grid-cols-[240px_minmax(0,1fr)]">
    ...
    <dialog id="mobile-menu" aria-label="Menu principal" class="admin-menu m-0 h-svh max-h-none w-[min(85vw,300px)] max-w-none border-0 bg-transparent p-0 text-white backdrop:bg-black/50 lg:hidden">
